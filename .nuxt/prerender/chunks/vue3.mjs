import * as proxy from 'file://C:/Users/Fraser/Websites/2022/nuxt3-example/node_modules/unenv/runtime/mock/proxy.mjs';
...
function renderToString$1(input, context = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        if (isVNode(input)) {
            // raw vnode, wrap with app (for context)
            return renderToString$1(vue.createApp({ render: () => input }), context);
        }
        // rendering an app
...
serverRenderer_cjs_prod.renderToString = renderToString$1;
