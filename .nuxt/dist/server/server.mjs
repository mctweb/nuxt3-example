...
import require$$0, { getCurrentInstance, reactive, toRef, isRef, defineComponent, computed, h, resolveComponent, watchEffect, ref, useSSRContext, mergeProps, withCtx, createTextVNode, toDisplayString as toDisplayString$1, unref, onErrorCaptured, createApp } from "vue";
...
const components = {};
function componentsPlugin_5135fede(nuxtApp) {
...
const vueuseHead_d957f2ae = defineNuxtPlugin((nuxtApp) => {
...
const plugin_0ad6309d = defineNuxtPlugin((nuxtApp) => {
...
const router_e792cafc = defineNuxtPlugin((nuxtApp) => {
  const routes = [];
  const hooks = {
    "navigate:before": [],
    "resolve:before": [],
